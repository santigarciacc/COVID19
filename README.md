...
![Head of code. Source on save must be ticked](https://github.com/JavierAlvarezLiebana/COVID19/blob/master/figures/head_code_source_on_save (1).jpg)
...
![Daily cases aligned by cases per each 1 millon habitants, 5th April 2020](https://github.com/JavierAlvarezLiebana/COVID19/blob/master/figures/daily_cases (1).jpg)
...
![Daily deaths aligned by cases per each 1 millon habitants, 5th April 2020](https://github.com/JavierAlvarezLiebana/COVID19/blob/master/figures/daily_deaths (1).jpg)
...
![Cum cases aligned by cases per each 1 millon habitants, 5th April 2020](https://github.com/JavierAlvarezLiebana/COVID19/blob/master/figures/cum_cases (1).jpg)


**Note that each figure is interactive and it can be enlarged just selecting the zoom area**

![Cum cases aligned by cases per each 1 millon habitants, 5th April 2020](https://github.com/JavierAlvarezLiebana/COVID19/blob/master/figures/zoom (1).jpg)
